...
-- =============================================
CREATE PROCEDURE [BPG_FinOps_Invoice_Reimbursement].[sp_BulkCostUpdate]
(
    @Ids nvarchar(MAX),
...
BEGIN
	...
	INSERT INTO [BPG_FinOps_Invoice_Reimbursement].[Log]
           ...
           ,[Description])
     VALUES
           ('[BPG_FinOps_Invoice_Reimbursement].[sp_BulkCostUpdate]'
           ,'Begin args: @Ids = ''' 
		    + CONVERT(NVARCHAR(MAX), @Ids) + ''' @IsSubmitted = '''
